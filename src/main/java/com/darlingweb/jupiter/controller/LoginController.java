...
import com.darlingweb.jupiter.entity.request.LoginRequestBody;
import com.darlingweb.jupiter.entity.response.LoginResponseBody;
import com.darlingweb.jupiter.service.LoginService;
...
public class LoginController {
    ...
    public void login (@RequestBody LoginRequestBody requestBody, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (!firstname.isEmpty()) {
            ...
            // no action after 600s, will log out
